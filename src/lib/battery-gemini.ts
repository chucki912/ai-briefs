...
## 출력 형식 (JSON)
{
  "headline": "한국어 헤드라인 (30자 이내, 핵심 사실 중심)",
  "keyFacts": [
  ...
  "insight": "위 4가지 핵심 사실을 종합하여, K-Battery(한국 배터리 산업)에 미치는 파급 효과와 전략적 시사점을 도출한 심층 인사이트 (공백 포함 300자 내외)",
...
- **핵심 사실**: 반드시 **4개의 핵심 사실**을 도출하여 \`keyFacts\` 배열에 담으세요. 각 사실은 독립적이고 구체적이어야 합니다.
- **심층 인사이트**:
  - 단순 요약이 아닌, 추출된 4가지 사실이 **한국 배터리 기업(LGES, SK On, SDI, 소재사 등)**에 어떤 기회나 위협이 되는지 분석하세요.
