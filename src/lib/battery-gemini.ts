...
## 출력 형식 (JSON)
{
  ...
  "keyFacts": [
    "핵심 사실 1 (구체적 수치/기업명 및 가능한 경우 출처·시점·신뢰도 명시, 예: CapEx $X (2026 Q1 가이던스 기준 / 미검증))",
    "핵심 사실 2 (출처·시점 명시)",
    "핵심 사실 3 (출처·시점 명시)"
  ],
  "insight": "인과관계가 흐르는 2~3문장 분량의 완성형 문단 형태 심층 인사이트. K-Battery(한국 배터리 산업) 생태계에 미치는 파급 효과와 전략적 시사점을 적용 분석 프레임워크의 개념을 녹여 완성형 문장으로 작성할 것.",
  "soWhat": {
